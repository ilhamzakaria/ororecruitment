...
$routes->get('/dashboard-hrd/activity-logs', 'Monitoring::getActivityLogs');
$routes->post('/dashboard-hrd/open-session', 'Monitoring::openSession');
$routes->post('/dashboard-hrd/bulk-open-session', 'Monitoring::bulkOpenSessions');
$routes->post('/dashboard-hrd/bulk-close-session', 'Monitoring::bulkCloseSessions');
$routes->post('/dashboard-hrd/unblock', 'Monitoring::unblockSession');
$routes->get('/manage-sessions', 'Monitoring::manageSessions');
